...
|[🏠️](/RUP/README.md)|[ 📊](/images/00-requisitos/01-casos-de-uso/2-DiagramaDeContexto/0-Administrador/DiagramaDeContextoAdministrador.svg)|[🔍 Análisis](/RUP/01-analisis/casos-uso/0-Administrador/asignarProfesorAExamen/README.md)|**Diseño**|Implementación|Pruebas|
|---|---|---|---|---|---|

...
|[🏠️](/RUP/README.md)|[ 📊](/images/00-requisitos/01-casos-de-uso/2-DiagramaDeContexto/0-Administrador/DiagramaDeContextoAdministrador.svg)|[Detalle](/RUP/00-requisitos/01-casos-de-uso/5-Prototipo/3-CasosDeUsoComunes/iniciarSesion/iniciarSesion.md)|**Análisis**|Diseño|Desarrollo|Pruebas|
|-|-|-|-|-|-|-|
...
|![Análisis iniciarSesion()](/images/01-analisis/casos-uso/0-Administrador/iniciarSesion/iniciarSesion-analisis.svg)|
|-|
...
- **Foco en enlaces**: Dependencias conceptuales entre objetos de análisis.
- **Mensajes de intención**: Expresan qué se quiere lograr a nivel de negocio.
...
### desde requisitos
- **Especificación detallada**: Define los estados y flujos que las clases deben soportar.
...
- **Colaboraciones**: Definen los patrones de interacción que se implementarán.

**Código fuente:** [colaboracion.puml](../../../../../modelosUML/01-analisis/casos-uso/0-Administrador/iniciarSesion/colaboracion.puml)
